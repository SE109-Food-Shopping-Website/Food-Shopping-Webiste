...
export default function SearchBar() {
    ...
    useEffect(() => {
        ...
        try {
            const res = await fetch(`/api/products/suggest?query=${debouncedQuery}`);
    ...
    return (
        <form
            ...
            {showSuggestions && suggestions.length > 0 && (
                <ul className="absolute top-11 left-0 z-[9999] w-full bg-white border border-gray-300 rounded shadow-md max-h-[300px] overflow-y-auto">
